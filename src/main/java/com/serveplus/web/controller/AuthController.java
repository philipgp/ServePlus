...
public class AuthController {
	...
	@RequestMapping(value = "/verifyForgotPasswordOtp", method = RequestMethod.POST)
	@ResponseBody
	public VerifyForgotPasswordOtpResponse verifyForgotPasswordOtp(@RequestBody VerifyForgotPasswordOtpRequest request){
